export const summariePolicyList = [
    {
      ...
      conditionsTerms: [
            ...
            },
            {
              ...
              text: "The platform helps users discover and connect with people, groups, businesses, and organizations of interest. Suggestions for joining groups, attending events, and following pages are based on user data and connections to create stronger and more meaningful communities."
            },
            {
              subtitle: "Self-expression",
              text: "Facebook provides multiple ways for users to express themselves and communicate with others, such as sharing updates, photos, videos, and stories. The platform also explores new technologies like augmented reality and 360° videos for more engaging content."
            },
            {
              subtitle: "Content Discovery",
              text: "Users are shown personalized ads, offers, and sponsored content to discover products and services offered by various businesses and organizations. Advertisers can target specific demographics and interests, and advertisers receive feedback on ad performance."
            },
            {
              subtitle: "Safety",
              text: "Ensuring user safety is a priority. Advanced technologies and global teams are employed to detect and counter inappropriate behavior. Meta shares data across its entities to maintain safety, assist users, and protect the community. Responses to harmful content include warnings, content removal, restricted access, and involvement of law enforcement."
            },
            {
              subtitle: "Ad Payment",
              text: "Instead of user fees, the platform's services are funded through ads and sponsored content. This enables free access to users while allowing businesses to promote their offerings."
            },
            {
              subtitle: "User Privacy",
              text: "While delivering personalized ads, Facebook doesn't reveal user identity to advertisers. Advertisers define target demographics and interests, and reports on ad performance are provided, safeguarding user privacy."
            },
            {
    ...
    {
      name: 'tiktok',
      policyWebpage: 'https://www.tiktok.com/legal',
      privacyTerms: [
        {
          "subtitle": "Data Collection:",
          "text": "Diverse user info, including profiles, content, messages, purchases, and identity proofs, is collected."
        },
        {
          "subtitle": "Automated Tracking:",
          "text": "User interactions, inferred traits, device details, location, and media attributes are gathered."
        },
        {
          "subtitle": "Cookies and Tools:",
          "text": "Cookies and tools aid data collection, analysis, and ad optimization."
        },
        {
          "subtitle": "Third-Party Links:",
          "text": "Third-party accounts and partners access data; advertisers and social media networks share user data."
        },
        {
          "subtitle": "Data Usage:",
          "text": "Collected data serves ads, personalization, security, analytics, and communication."
        },
        {
          "subtitle": "Data Sharing:",
          "text": "User data is shared with partners, advertisers, law enforcement, and affiliates. Public profiles and posts may be visible."
        },
        {
          "subtitle": "Security Measures:",
          "text": "User data is secured with technical and admin safeguards on global servers."
        },
        {
          "subtitle": "User Control:",
          "text": "Users have rights to access, modify, and manage data; can control cookies and privacy settings."
        },
        {
          "subtitle": "Data Retention:",
          "text": "Data is kept based on necessity for platform provision, legal compliance, and commercial interests."
        },
        {
          "subtitle": "Child Protection:",
          "text": "Platform not for users under 13; local laws may raise age requirement. Parent's Guide available."
        },
        {
          "subtitle": "Policy Updates:",
          "text": "Users informed of changes; continued use post-update implies acceptance."
        },
        {
          "subtitle": "Contact:",
          "text": "Users can address privacy concerns via provided link; complaints to data authorities also possible."
        },
        {
          "subtitle": "Local Terms:",
          "text": "Jurisdiction-specific terms apply; in Argentina, data protection rights exist."
        },
        {
          "subtitle": "Secondary Uses:",
          "text": "Data used for personalized ads, not critical for platform use; user can limit such use."
        },
        {
          "subtitle": "Minor Consent:",
          "text": "Parent's Consent section in Terms of Service provides guidance."
        }
      ],
      vigencyOfPrivacy: '05/04/2023',
      conditionsTerms: [
        {
          "subtitle": "Platform Usage",
          "text": "TikTok, provided by TikTok Pte. Ltd., allows personal, non-commercial use, creating a user-TikTok agreement."
        },
        {
          "subtitle": "Acceptance",
          "text": "Accessing TikTok implies agreement to terms, Privacy Policy, and Community Guidelines, including jurisdiction-specific terms."
        },
        {
          "subtitle": "Terms Changes",
          "text": "TikTok can alter terms, with continued use signifying acceptance. Users should stay informed about changes."
        },
        {
          "subtitle": "Account Responsibility",
          "text": "Users must create accurate accounts, safeguard passwords, and report compromises; violations can lead to account suspension."
        },
        {
          "subtitle": "Service Adherence",
          "text": "Compliance with terms, laws, and Community Guidelines is essential. Unauthorized distribution and interference are restricted."
        },
        {
          "subtitle": "Intellectual Property",
          "text": "Respect for copyrights is vital; TikTok can take action against copyright infringement."
        },
        {
          "subtitle": "Content Handling",
          "text": "TikTok holds content ownership; users can generate value but lack revenue rights. User content is analyzed through automated systems."
        },
        {
          "subtitle": "User Content",
          "text": "User-generated content has crucial points:\n\nContent Variety: Users can share diverse content like photos, videos, and music.\nCollaboration: Users can create combined content, using TikTok's resources.\nResponsibility: Users ensure content compliance; TikTok doesn't verify content.\nConfidentiality: Users shouldn't upload confidential material.\nTikTok License: TikTok gains rights to use user content globally.\nPublic Access: Content might be public unless privacy settings are adjusted.\nModeration: TikTok can remove or block violating content; users advised to save personal copies.\nIndemnification: Users hold responsibility for their content; TikTok's indemnification right."
        }
      ],
      ...
      privacyTerms: [
        {
          ...
          text: "Pinterest's mission is to inspire individuals to create their desired life by delivering personalized content and ads based on user data and preferences."
        },
        {
          subtitle: "Scope of Privacy Policy",
          text: "This is Pinterest's global privacy policy, with specific sections tailored to users based on their location. For users in the EEA, Switzerland, or the UK, Pinterest Europe Ltd. and Pinterest, Inc. share data controller responsibilities."
        },
        {
          subtitle: "Information Collection",
          text: "Pinterest collects data through various means, including user-provided information, interaction with content, location sharing, and customer support communication."
        },
        {
          subtitle: "Technical Information",
          text: "Automatically collected data includes device type, operating system, network provider, and unique identifiers."
        },
        {
          subtitle: "Cookies and Similar Technologies",
          text: "Pinterest uses cookies for purposes like language preferences and personalization, with more details available in the Cookie Policy."
        },
        {
          subtitle: "Data from Partners",
          text: "Pinterest receives data from affiliates, advertisers, technical service partners, and others to enhance user experiences and ad targeting."
        },
        {
          subtitle: "How We Use Your Information",
          text: "Pinterest employs user data for identification, content recommendations, query responses, community creation, location-based personalization, and communication."
        },
        {
          subtitle: "Improving Services and Protecting Users",
          text: "Pinterest reviews user activity to detect spam, suspicious behavior, or policy violations. Data analysis enhances products, generates aggregated or anonymized data, and ensures user safety and legal compliance."
        }
      ],
      vigencyOfPrivacy: '01/08/23',
      conditionsTerms: [
        {
          "subtitle": "Pinterest's Purpose",
          "text": "Pinterest is all about inspiring users to create their desired life by curating content relevant to their interests. While advertisers may promote content, it will always be clearly marked."
        },
        {
          "subtitle": "Usage and Age Limitations",
          "text": "Users must follow the rules and adhere to applicable laws. Only individuals aged 13 or older (and meeting their country's minimum age requirement) are allowed to use Pinterest. Those aged 13 to 18 require parental or guardian consent. Users with deactivated accounts can't create new ones without explicit permission."
        },
        {
          "subtitle": "Prohibited Actions",
          "text": "Unauthorized access, collection, copying, or use of Pinterest's data or content is strictly prohibited. The service should not be used for unlawful activities and must comply with trade restrictions."
        },
        {
          "subtitle": "User License",
          "text": "Pinterest grants users a limited, non-exclusive, and revocable license to access and use the service, subject to these terms and policies. Commercial use requires a business account."
        },
        {
          "subtitle": "User-Generated Content",
          "text": "Users retain rights to the content they post, but it must adhere to the terms and policies. Pinterest can take action against content that violates these rules."
        },
        {
          "subtitle": "Content Sharing and Licensing",
          "text": "When users post content, they grant Pinterest and others a worldwide, non-exclusive license to use, store, and distribute it. Pinterest uses various factors to recommend content to users."
        },
        {
          "subtitle": "Data Retention",
          "text": "Pinterest may retain user content for backup or audit purposes even after account deletion. Other users may continue to use and share saved content."
        },
        {
          "subtitle": "Security and Third-Party Links",
          "text": "While Pinterest prioritizes security, users should safeguard their passwords. Pinterest does not take responsibility for third-party websites or services linked from its platform."
        }
      ],

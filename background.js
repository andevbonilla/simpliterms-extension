chrome.tabs.onUpdated.addListener((tabId, tab) => {
  ...
  const listUrls = [
      {
        name: 'google',
        policyWebpage: 'policies.google.com',
    ...
    {
        name: 'facebook',
        policyWebpage: ['facebook.com/legal/terms', 'facebook.com/privacy'],
    ...
    {
        name: 'instagram',
        policyWebpage: ['privacycenter.instagram.com', 'help.instagram.com'],
    ...
    {
        name: 'twitter',
        policyWebpage: 'twitter.com/es/tos',
  ...
  for (const summary of listUrls) {
    if (tab.url.includes(summary.policyWebpage.includes())) {
